                ...
                <div className="flex items-center gap-3">
                    ...
                    <DropdownMenu>
                        ...
                        >
                            ...
                            <DropdownMenuGroup>
                                <DropdownMenuItem className="px-3 py-2.5 rounded-lg cursor-pointer hover:bg-city-blue/5 transition-colors">
                            ...
                            <DropdownMenuSeparator className="my-2" />
                            <DropdownMenuItem className="px-3 py-2.5 rounded-lg cursor-pointer text-red-600 hover:bg-red-50 transition-colors">
