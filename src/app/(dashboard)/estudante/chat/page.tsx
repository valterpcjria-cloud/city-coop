...
export default function StudentChatPage() {
    ...
    // Fetch student data for context if needed
        ...
        setMessages([
            {
                id: 'welcome',
                role: 'assistant',
                content: 'Olá! Sou o seu DOT Assistente cooperativista. Como posso te ajudar hoje?'
            } as any
        ]);
                                ...
                                >
                                    <Avatar className={cn(
                                        ...
                                        {m.role === 'assistant' ? (
                                            ...
                                            <AvatarFallback className="bg-transparent text-white font-bold text-xs">U</AvatarFallback>
                                        )}
                                    </Avatar>
                    ...
                    <div className="max-w-3xl mx-auto space-y-4 pt-4">
                        <div className="flex items-center justify-between px-2 mb-1">
                            <div className="flex gap-1.5 items-center">
                                <span className="text-[10px] font-bold text-[#6B7C93] uppercase tracking-wider">Cérebro:</span>
                                <div className={cn(
                        ...
                        >
                            <Textarea
                                ...
                                placeholder="Tire sua dúvida com o DOT..."
                        ...
                        <p className="text-[10px] text-center text-slate-400 font-medium tracking-tight">O DOT Assistente pode fornecer sugestões úteis. Sempre consulte seu professor em caso de dúvida.</p>
                    </div>
                </div>
            </div>
        </div>
